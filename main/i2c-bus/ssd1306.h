...
static int ssd1305_init() 
{
   ...
   i2c_write( 0x3c,  0x00,  0x80 );       // freq 0x80
   i2c_write( 0x3c,  0x00,  0xa8 );    // multiplex
   i2c_write( 0x3c,  0x00,  0x3f );       // 64 mux
   i2c_write( 0x3c,  0x00,  0xd3 );    // offset
   i2c_write( 0x3c,  0x00,  0x00 );       // 0x00
   i2c_write( 0x3c,  0x00,  0x40 );    // startline 0x00
   i2c_write( 0x3c,  0x00,  0x8d );    // charge pump  - not in latest spec
   i2c_write( 0x3c,  0x00,  0x14 );
   i2c_write( 0x3c,  0x00,  0x20 );    // memory mode
   i2c_write( 0x3c,  0x00,  0x00 );       // 00b horizontal
   i2c_write( 0x3c,  0x00,  0xa1 );    // segregmap  - 0b
   i2c_write( 0x3c,  0x00,  0xc8 );    // comscandec - scan dir no used
   i2c_write( 0x3c,  0x00,  0xda );    // set com pins
   i2c_write( 0x3c,  0x00,  0x12 );       // as reset
   i2c_write( 0x3c,  0x00,  0x81 );    // contrast
   i2c_write( 0x3c,  0x00,  0xcf );       // reset is 0x80
   i2c_write( 0x3c,  0x00,  0xd9 );    // precharge period
   i2c_write( 0x3c,  0x00,  0xf1 );       // reset - 0x22
   i2c_write( 0x3c,  0x00,  0xdb );    // vcom seltect
   i2c_write( 0x3c,  0x00,  0x40 );       // 0x34 - reset .77vcc
   i2c_write( 0x3c,  0x00,  0xa4 );    // resume - display on show ram
   i2c_write( 0x3c,  0x00,  0xa6 );    // normal (not inverted)
// ic2_write( 0x3c,  0c00,  0x00 );    
